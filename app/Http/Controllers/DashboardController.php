...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Total penjualan hari ini (Hanya ambil status yang sudah selesai/lunas)
        // Ganti 'completed' dengan status sukses di database Anda (misal: 'selesai', 'lunas', atau 'paid')

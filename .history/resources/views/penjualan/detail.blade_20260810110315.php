...
<div style="background:#FAF4EE; min-height:90vh; padding:40px 20px; font-family:'Poppins',sans-serif;">
    <div style="max-width:1100px; margin:auto;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:30px;">
            ...
            <a href="{{ route('penjualan.index') }}" style="background:#EFE6DC; color:#5C4838; padding:12px 22px; border-radius:14px; text-decoration:none; font-weight:600;">
                ← Kembali
            </a>
        </div>
            ...
            <div style="padding:25px;">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <h5 style="color:#8B5E3C; font-weight:700;">
            ...
            <div style="padding:25px; overflow-x:auto;">
                <table width="100%" style="border-collapse:collapse;">
                    ...
                    <tbody>
                        @forelse ($penjualan->details as $item)
                            <tr style="border-bottom:1px solid #F0E2D3;">
                                ...
                                <td style="text-align:center; padding:15px;">
                                    ...
                                    @else
                                        <div style="width:65px; height:65px; background:#F5E6D8; border-radius:15px; display:flex; align-items:center; justify-content:center; font-size:25px;">
                                            🥐
                                        </div>
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" style="text-align:center; padding:30px; color:#8C7A6B;">
                                    Belum ada produk 🥖
                                </td>
                            </tr>
                        @endforelse

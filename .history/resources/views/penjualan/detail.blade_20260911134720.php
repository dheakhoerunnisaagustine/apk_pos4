            ...
            <div style="padding: 25px;">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <h6 style="color: #4A3525; font-weight: 600;">
                            <span style="background: #EFE6DC; padding: 4px 10px; border-radius: 8px; font-size: 13px;">
                                {{ $penjualan->metode_pembayaran ?? $penjualan->payment_method ?? 'CASH' }}
                            </span>
                        </h6>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4 style="color: #8B5E3C; font-weight: 700; margin: 0;">
...
{{-- ========================================================= --}}
{{-- TEMPLATE STRUK KHUSUS UNTUK PRINTER THERMAL (SAAT DICETAK) --}}
{{-- ========================================================= --}}
<div id="receipt-print-area">
    ...
    <div style="border-top: 1px dashed #000; border-bottom: 1px dashed #000; padding: 4px 0; margin-bottom: 6px; font-size: 9px;">
        ...
        <div>Metode: {{ $penjualan->metode_pembayaran ?? $penjualan->payment_method ?? 'CASH' }}</div>
    ...
    <div style="border-top: 1px dashed #000; padding-top: 4px; font-size: 9px;">
        <div style="display: flex; justify-content: space-between;">
            <strong>TOTAL:</strong>
            <strong style="float: right;">Rp {{ number_format($penjualan->total_pembayaran, 0, ',', '.') }}</strong>
        </div>
    </div>

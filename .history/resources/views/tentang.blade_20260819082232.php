            ...
            <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 p-md-5 bg-white">
                    ...
                    <div class="text-center mb-5">
                        {{-- Ganti 'path/ke-foto-anda.jpg' dengan lokasi foto Anda, atau gunakan link gambar --}}
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-dark mb-3">
                            <i class="bi bi-laptop me-2 text-warning"></i>Pengembangan Aplikasi
                        </h5>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-dark mb-3">
                            <i class="bi bi-cpu me-2 text-warning"></i>Teknologi yang Digunakan
                        </h5>
                    ...
                    <div>
                        <h5 class="fw-bold text-dark mb-3">
                            <i class="bi bi-person-badge me-2 text-warning"></i>Informasi Pengembang
                        </h5>

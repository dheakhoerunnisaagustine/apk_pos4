                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            <thead class="table-light text-secondary small text-uppercase">
                                <tr>
                                    <th class="text-center py-2" style="width: 10%;">No</th>
                    ...
                    @forelse($produkTerlaris as $index => $produk)
                        <tr>
                            ...
                            <td class="text-center">
                                @if($produk->stok <= 5)
                                    <span class="badge bg-warning text-dark px-2 py-1 rounded-pill fw-semibold" style="min-width: 32px;">
                                        {{ $produk->stok }}
                                    </span>
                                @else
                                    <span class="badge bg-success px-2 py-1 rounded-pill fw-semibold" style="min-width: 32px;">
                                        {{ $produk->stok }}
                                    </span>
                                @endif
                            </td>

                ...
                <table width="100%" style="border-collapse:collapse;">
                    <thead>
                        <tr style="background:#FAF4EE; color:#5C4838; font-size:14px; text-transform:uppercase; letter-spacing:0.5px;">
                            ...
                            <th style="padding:15px; text-align:right; width:14%;">Harga Beli</th>
                            <th style="padding:15px; text-align:right; width:14%;">Harga Jual</th>
                    ...
                    @forelse($products as $product)
                        <tr style="border-bottom:1px solid #F0E2D3;">
                            ...
                            <td style="text-align:right; padding:15px; color:#6C5C50; font-weight:500;">
                                Rp {{ number_format($product->harga_beli, 0, ',', '.') }}
                            </td>

                            <!-- Harga Jual (Rata Kanan & Bold) -->
                            <td style="text-align:right; padding:15px; color:#8B5E3C; font-weight:700;">
                                Rp {{ number_format($product->harga_jual, 0, ',', '.') }}
                            </td>

                            <!-- Stok (Soft Badge Sesuai Tingkat Sisa) -->
                            <td style="text-align:center; padding:15px;">
                                @if($product->stok <= 0)

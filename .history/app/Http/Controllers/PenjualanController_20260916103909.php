...
class PenjualanController extends Controller
{
    ...
    {
        // 1. Validasi input pembayaran dan uang yang dibayar
        $request->validate([
        ...
        DB::transaction(function () use ($penjualan, $request, $total, $uangDibayar, $kembalian) {
            $penjualan->update([
                ...
                'uang_dibayar'      => $uangDibayar, // Menyimpan uang asli dari kasir
                'kembalian'         => $kembalian,   // Menyimpan hasil kembalian
                'status'            => 'COMPLETED'
            ]);
        });
